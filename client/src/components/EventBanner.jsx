...
function EventBanner() {
    return (
        <div className="relative z-[2] bg-black/20 h-[400px] flex flex-col items-center justify-center gap-10 sm:gap-7 lg:gap-5 w-full ">
            <p className="font-[500] text-[1.7rem] sm:text-[2rem] text-white/90">IEEE IES IEM - A Events & Programs Hub</p>
